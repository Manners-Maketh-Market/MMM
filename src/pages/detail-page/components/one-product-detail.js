...
const OneProductDetail = () => {
    ...
    // 물품 상세 정보
    const { data: detailProduct, refetch } = useQuery([PRODUCT_QUERY_KEY.DETAIL_PRODUCT_DATA], () =>
    ...
    const { mutateAsync: onSellMutation, data: sellData } = useMutation((requestData) =>
        Api.postSaleComplete(requestData)
    );
                    ...
                    <ProductDetail>
                        ...
                        <ImgAndInform>
                            ...
                            <Inform>
                                ...
                                <FlexBox>
                                    <Price>{PriceComma(detailProduct.searchProduct.price)}원</Price>
                                ...
                                {detailProduct.searchProduct.User.nick_name !== userInfoData.nick_name && (
                                    <ButtonBox>
                                        <MMMButton
                                            variant={detailProduct.searchProduct.liked === 1 ? 'detailY' : 'detailG'}
                                            size={'medium'}
