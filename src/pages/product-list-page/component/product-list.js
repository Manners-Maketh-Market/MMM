...
const ProductList = () => {
    ...
    const { data: productList } = useInfiniteQuery([PRODUCT_QUERY_KEY.MORE_PRODUCT_LIST, saleStatus], () =>
    ...
    return (
        productList && (
            <>
                <S.TitleWrapper>
                    <ProductPageTitle totalProductsCount={productList.pages[0][0].length} />
                </S.TitleWrapper>
                <hr />
