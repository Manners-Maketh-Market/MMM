    ...
    const { data: searchUsedProducts, fetchNextPage } = useInfiniteQuery(
        ...
        ({ pageParam = 1 }) => Api.getSearchProduct(0, searchValue, pageParam),
        {
            getNextPageParam: (lastPage) => {
                return lastPage.pagination.curPage < lastPage.pagination.totalPage && lastPage.pagination.curPage + 1;
            },
        }
    );
            ...
            <S.Wrapper>
                {searchUsedProducts.pages[0].product.length === 0 ? (
                    ...
                    <>
                        <S.TitleWrapper>
                            <SearchPageTitle
                                totalProductsCount={searchUsedProducts.pages[0].pagination.count}
